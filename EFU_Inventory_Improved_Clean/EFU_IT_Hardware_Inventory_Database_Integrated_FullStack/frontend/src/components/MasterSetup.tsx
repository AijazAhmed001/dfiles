...
const masterConfigs: Record<string, MasterConfig> = {
  ...
  motherboard: {
    ...
    fields: [
      { key: 'name', label: 'Processor Name', required: true },
  ...
  memory: {
    ...
    fields: [
      { key: 'size', label: 'Memory Size', required: true },
  ...
  storage: {
    ...
    fields: [
      { key: 'type', label: 'Storage Type', required: true },
  ...
  'operating-system': {
    ...
    fields: [
      { key: 'name', label: 'OS Name', required: true },
  ...
  province: {
    title: 'Province',
    rowKeys: ['name', 'status'],
    fields: [{ key: 'name', label: 'Province Name', required: true }, statusField],
  },
  city: {
    title: 'City',
  ...
  department: {
    title: 'Department',
    rowKeys: ['name', 'status'],
    fields: [{ key: 'name', label: 'Department Name', required: true }, statusField],
  },
  office: {
    title: 'Office',
                ...
                visibleRows.map((row, index) => (
                  ...
                  >
                    ...
                    {config.rowKeys.map((key) => {
                      ...
                      if (key === 'status') {
                        const badge = statusBadgeStyle(value)

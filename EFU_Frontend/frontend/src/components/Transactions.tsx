  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [assetPage, employeePage, locationPage] = await Promise.all([
        api.getPage<AssetOption>(`/assets?page=1&limit=100&activeOnly=true${suffix}`),
        api.getPage<NamedOption>(
          "/master/employee?page=1&limit=100&activeOnly=true",
        ),
        api.getPage<NamedOption>(
          "/master/location?page=1&limit=100&activeOnly=true",
        ),
      ])
        ...
        summary={
          <>
            ...
            <SummaryRow
              ...
              value={
                form.salvage
                  ? `PKR ${Number(form.salvage).toLocaleString()}`
                  : undefined
              }
            />
          </>

...
const phrase =
  'I build ambitious digital products where thoughtful interfaces meet reliable systems, artificial intelligence and cloud engineering.';
        ...
        <div className='basis-7/12 lg:basis-3/12'>
          <ParallaxFade>
            <Balancer as='p' className='mt-2 text-base lg:text-lg'>
              Based in Karachi, I turn complex requirements into clean,
              scalable products using React, .NET and modern cloud tools.
            </Balancer>
          </ParallaxFade>
        </div>

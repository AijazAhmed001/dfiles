...
import efuHouseDay from "../assets/images/efu-house-day.png";
import efuLogo from "../assets/images/efu-login-logo.png";
        ...
        <main className="auth-layout">
            <section className="auth-visual">
                ...
                <div className="auth-introduction">
                    ...
                    <div className="auth-introduction__line" />

                    <p>
                        Secure insights, smarter decisions and better outcomes
                        for your business.
                    </p>
                ...
                <div className="auth-trust-card">
                    ...
                    <div>
                        <strong>Trusted by EFU General Insurance</strong>
                        <span>
